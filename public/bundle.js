...
var _booksreducers = __webpack_require__(72);

var _cartreducers = __webpack_require__(73);
...
function booksReducers() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    books: [{ id: 1, name: "Da vince code", author: "Dan Brown", price: 10 }, { id: 2, name: "Digital code", author: "Dan Brown", price: 20 }]
  };
  var action = arguments[1];

  switch (action.type) {
    case "get_book":
      return { books: [].concat(_toConsumableArray(state.books)) };
      break;
    ...
    case "update_book":
      var book2upt = [].concat(_toConsumableArray(state.books));
      var indextoupt = book2upt.findIndex(function (book) {
        return book.id === action.payload.id;
      });
      var newbook = _extends({}, book2upt[indextoupt], { name: action.payload.name });
      console.log(newbook);
      return {
        books: [].concat(_toConsumableArray(book2upt.slice(0, indextoupt)), [newbook], _toConsumableArray(book2upt.slice(indextoupt + 1)))
      };
      break;
  }
  return state;
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ getbook: _booksactions.getbook }, dispatch);
}
