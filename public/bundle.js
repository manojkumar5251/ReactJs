...
store.dispatch((0, _booksactions.postbook)([{ id: 1, name: "Da vince code", author: "Dan Brown", price: 10 }, { id: 2, name: "Digital code", author: "Dan Brown", price: 20 }]));

store.dispatch((0, _booksactions.deletebook)({ id: 1 }));

store.dispatch((0, _booksactions.updatebook)({ id: 2, name: "Angels and Demons" }));
